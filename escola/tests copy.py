...
class TestModels(TestCase):
    ...
    def test_course_model(self):
        ...
        self.assertEqual(course.code, 'C001')
...
class TestSerializers(TestCase):
    ...
    def test_course_serializer(self):
        ...
        self.assertEqual(serializer.data['code'], 'C001')
...
class TestViews(TestCase):
    ...
    def test_list_registration_student(self):
        ...
        response = self.client.get(reverse('list-registration-student', args=[student.id]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
    ...
    def test_list_registration_course(self):
        ...
        response = self.client.get(reverse('list-registration-course', args=[course.id]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)